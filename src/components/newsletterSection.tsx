...
export default function NewsletterSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Aqui seria implementada a lógica de newsletter
  ...
  return (
    <section
      className="py-20"
      style={{ background: "linear-gradient(90deg, #9BD60C, #00D1FF)" }}
    >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="font-body text-lg text-white/90 max-w-2xl mx-auto">
              Fique por dentro de todos os eventos, novidades do bistrô e
              lançamentos do nosso selo musical. Não perca nenhuma novidade!
            </p>
          </div>
          ...
          <div className="max-w-md mx-auto mb-8">
            ...
            >
              <input
                ...
                className="flex-1 h-12 px-4 bg-white/90 backdrop-blur-md border-0 rounded-xl text-[#022744] placeholder:text-[#022744]/60 font-body focus:outline-none focus:ring-2 focus:ring-white"
                required
              />
              <button
                type="submit"
                className="px-6 py-3 bg-[#9BD60C] hover:bg-[#9BD60C]/80 text-white font-display font-semibold rounded-xl transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-2 whitespace-nowrap"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
